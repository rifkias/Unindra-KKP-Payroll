 ...
 * @author lincbp
 */
public class PajakForm extends javax.swing.JPanel {
    private PajakController controller;

    /**
     * Creates new form DivisionForm
     */
    public PajakForm(LoginModel loginModel) {
        initComponents();
        
        controller = new PajakController(this);
        controller.isiTable();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Master Data > Pajak");
        ...
        percentageTxt.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0.00"))));
